...
public static class ObjectExpectationWriterAttachment
{
    ...
    /// </summary>
    /// <param name="output"><inheritdoc cref="ExpectationRenderFactoryContext{T}" path="/param[@name='output']"/></param>
    /// <param name="actual"><inheritdoc cref="ExpectationRenderFactoryContext{T}" path="/param[@name='actual']"/></param>
    /// <param name="rendererFactory"><inheritdoc cref="ExpectationRenderFactoryContext{T}" path="/param[@name='rendererFactory']"/></param>
